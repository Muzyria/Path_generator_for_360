...
class SettingsDateTime(AppiumBasePage):
    ...
    @staticmethod
    def get_new_time_tuple(extra_minute=5) -> tuple:
        """конвертер текущего времени в формат AM/PM
            округляем миуты равным 5
            также добовляем 5 минут к финальному результату"""
